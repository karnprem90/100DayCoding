...
**/
select team_id, team_name, (wins *3 + draws) as points,  DENSE_RANK() OVER (order by (wins * 3 + draws) DESC) as position from TeamStats order by points DESC, team_name ASC;